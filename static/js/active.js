...
let copywriteYear = document.getElementById('copywriteYear');
...
// Fungsi untuk menangani perubahan pilihan pada dropdown payment method
document.getElementById('payment_method').addEventListener('change', function() {
    var paymentMethod = this.value;
    
    // Menampilkan/hide rekening tujuan dan upload bukti transfer sesuai pilihan
    if (paymentMethod === 'bank_transfer') {
      document.getElementById('rekening_tujuan').style.display = 'block';
      document.getElementById('bukti_transfer').style.display = 'block';
    } else {
      document.getElementById('rekening_tujuan').style.display = 'none';
      document.getElementById('bukti_transfer').style.display = 'none';
    }
  });

  // Ketika modal di-trigger, ambil order_id dan lakukan AJAX request untuk mengambil data order detail
  $('#orderDetailModal').on('show.bs.modal', function (event) {
    var button = $(event.relatedTarget); // Tombol yang memicu modal
    var orderId = button.data('order-id'); // Ambil order_id dari tombol
    var modal = $(this);
    
    // Lakukan AJAX untuk mengambil data order detail berdasarkan order_id
    $.ajax({
      url: '/order_detail/' + orderId, // URL untuk mengambil detail order
      method: 'GET',
      success: function(response) {
        // Update modal dengan konten baru
        modal.find('#orderDetailContent').html(response);
      },
      error: function() {
        modal.find('#orderDetailContent').html('<p>Failed to load order details.</p>');
      }
    });
  });

// document.addEventListener('DOMContentLoaded', function() {
//     var categorySelect = document.getElementById('category_id'); // Sesuaikan dengan ID di HTML
//     var NotebookbrandSelect = document.getElementById('notebook_brand_select');
//     var MainboardbrandSelect = document.getElementById('mainboard_brand_select');
//     var ProcessorbrandSelect = document.getElementById('processor_brand_select');
//     var gamingNotebookbrandSelect = document.getElementById('gamingNotebook_brand_select');

//     // Sembunyikan elemen Form pada awal
//     NotebookbrandSelect.style.display = 'none';
//     MainboardbrandSelect.style.display = 'none';
//     ProcessorbrandSelect.style.display = 'none';
//     gamingNotebookbrandSelect.style.display = 'none';

//     categorySelect.addEventListener('change', function() {
//         var category_name = this.options[this.selectedIndex].text;

//         if (category_name === 'Notebook') {
//             NotebookbrandSelect.style.display = 'block';
//             MainboardbrandSelect.style.display = 'none';
//             ProcessorbrandSelect.style.display = 'none';
//             gamingNotebookbrandSelect.style.display = 'none';
//         } else if (category_name === 'Mainboard') {
//             MainboardbrandSelect.style.display = 'block';
//             NotebookbrandSelect.style.display = 'none';
//             ProcessorbrandSelect.style.display = 'none';
//             gamingNotebookbrandSelect.style.display = 'none';
//         } else if (category_name === 'Processor') {
//             ProcessorbrandSelect.style.display = 'block';
//             MainboardbrandSelect.style.display = 'none';
//             NotebookbrandSelect.style.display = 'none';
//             gamingNotebookbrandSelect.style.display = 'none';
//         } else if (category_name === 'Gaming Notebook') {
//             gamingNotebookbrandSelect.style.display = 'block';
//             MainboardbrandSelect.style.display = 'none';
//             NotebookbrandSelect.style.display = 'none';
//             ProcessorbrandSelect.style.display = 'none';
//         } else {
